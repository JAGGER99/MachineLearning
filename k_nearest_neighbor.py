...
class KNearestNeighbor(object):
    ...
    def compute_distances_two_loops(self, X):
        ...
        for i in range(num_test):
            for j in range(num_train):
                ...
                # Taking the dot product to find the sum of the squares
                sum_sq = np.dot(temp.T, temp)
 
                # Taking squareroot to get Euclidean distance
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            top_k_train_indices = dists[i].argsort()[:k]
            closest_y = self.y_train[top_k_train_indices]
